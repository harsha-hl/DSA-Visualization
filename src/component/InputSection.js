  ...
  render() {
    return (
      <section className='input-section'>
        ...
        <button className='precaution' onClick={this.changeShow}><img className='cautionImg' src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRddp8r__54FaCjm2ligo-uCYlSDn8EZauklroxoN38fZV7MzcsR-7Jw9IHw8-DEs01FIs&usqp=CAU'} alt='caution'/></button>    
        <button className='input-button glow-on-hover' onClick={input => this.setState({submit: true})}>Run</button>
